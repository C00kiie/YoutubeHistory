...
DEVELOPER_KEY = 'API_KEY'#'REPLACE_ME'
...
def youtube_search(search_term,max_results):
  ...
  return video_arr
# save a search in an html format
...
## by default, it reades from a file called input.txt
## outputs to search_term.html for each search in the input file
